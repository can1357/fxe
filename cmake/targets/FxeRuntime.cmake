...
add_custom_target(bundle_loader DEPENDS fxe_runtime)
...
if(TARGET zstd::libzstd_shared)
    set(_fxe_zstd_target zstd::libzstd_shared)
elseif(TARGET zstd::libzstd_static)
    set(_fxe_zstd_target zstd::libzstd_static)
elseif(TARGET zstd::libzstd)
    set(_fxe_zstd_target zstd::libzstd)
endif()
if(_fxe_zstd_target)
    target_link_libraries(fxe_runtime PRIVATE ${_fxe_zstd_target})
